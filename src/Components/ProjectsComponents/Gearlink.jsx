...
const Gearlink = () => {
  return (
    <Tilt
      ...
      <section className="  cardContainer  mx-auto shadow-2xl shadow-pink-600 ">
        ...
        <a href="https://movatti.vercel.app" target="blank" className=" text-black text-sm bg-white rounded-2xl font-serif  italic p-2 hover:opacity-70 cursor-pointer demobtn ">
          View Demo
        </a>
      </section>
      </div>
